    ...
    { label: "Interests", logoSrc: "interests.svg" },
          ...
          const projectsDetails = [
            ...
            },
            {
              ...
              description:
                "User interface clone netflix website ",
              subHeading:
                "Technologies Used: HTML, CSS, js,React ,MongoDB,Firebase,Redux, Nodejs, Bootstrap.",
            },{
            title: "Reservation Ticket ",
            duration: { fromDate: "2021", toDate:"2022"},
            description:
              "Event poster and ticket booking website ",
            subHeading:
              "Technologies Used: HTML, CSS, js,React ,MongoDB,Firebase,Redux, Nodejs, Mui.",
          }
          ];
          ...
          const resumeDetails = [
            <div className="resume-screen-container" key="education">
              ...
              <ResumeHeading
                heading={"fundamental license "}
                subHeading={"FUNDAMENTAL LICENSE IN TELECOMMUNICATIONS ELECTRONICS"}
                fromDate={"2014"}
                toDate={"2017"}
              />
              <ResumeHeading
                heading={"Professional Master"}
                subHeading={"MASTER'S DEGREE EMBADDED SYSTEMS"}
                fromDate={"2018"}
                toDate={"2020"}
              />
            </div>,
            ...
            <div className="resume-screen-container" key="work-experience">
              <div className="experience-container">
                <ResumeHeading
                  heading={"Freelance"}
                  subHeading={"JS DEVELOPER"}
                  fromDate={"2021"}
                  toDate={"2022"}
                />
                <div className="experience-description">
                  <span className="resume-description-text">
                    Work as FullStack Js
                  </span>
                </div>
              </div>
            </div>,
